...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_19_BAD_ACTOR_ENFORCEMENT) r = SPORK_19_BAD_ACTOR_DEFAULT;
        if (nSporkID == SPORK_20_DISABLE_OBFUSCATION_ENFORCEMENT) r = SPORK_20_DISABLE_OBFUSCATION_DEFAULT;
        if (nSporkID == SPORK_21_TREASURY_PAYMENT_ENFORCEMENT) r = SPORK_21_TREASURY_PAYMENT_DEFAULT;
        if (nSporkID == SPORK_22_SEGWIT_ACTIVATION) r = SPORK_22_SEGWIT_ACTIVATION_DEFAULT;
        if (nSporkID == SPORK_23_ZEROCOIN_MAINTENANCE_MODE) r = SPORK_23_ZEROCOIN_MAINTENANCE_MODE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_19_BAD_ACTOR_ENFORCEMENT") return SPORK_19_BAD_ACTOR_ENFORCEMENT;
    if (strName == "SPORK_20_DISABLE_OBFUSCATION_ENFORCEMENT") return SPORK_20_DISABLE_OBFUSCATION_ENFORCEMENT;
    if (strName == "SPORK_21_TREASURY_PAYMENT_ENFORCEMENT") return SPORK_21_TREASURY_PAYMENT_ENFORCEMENT;
    if (strName == "SPORK_22_SEGWIT_ACTIVATION") return SPORK_22_SEGWIT_ACTIVATION;
    if (strName == "SPORK_23_ZEROCOIN_MAINTENANCE_MODE") return SPORK_23_ZEROCOIN_MAINTENANCE_MODE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_19_BAD_ACTOR_ENFORCEMENT) return "SPORK_19_BAD_ACTOR_ENFORCEMENT";
    if (id == SPORK_20_DISABLE_OBFUSCATION_ENFORCEMENT) return "SPORK_20_DISABLE_OBFUSCATION_ENFORCEMENT";
    if (id == SPORK_21_TREASURY_PAYMENT_ENFORCEMENT) return "SPORK_21_TREASURY_PAYMENT_ENFORCEMENT";
    if (id == SPORK_22_SEGWIT_ACTIVATION) return "SPORK_22_SEGWIT_ACTIVATION";
    if (id == SPORK_23_ZEROCOIN_MAINTENANCE_MODE) return "SPORK_23_ZEROCOIN_MAINTENANCE_MODE";
