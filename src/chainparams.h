 ...
 * Altbet system. There are three: the main network on which people trade goods
...
public:
    ...
    int MasternodeCollateralAmtNewEnd() const { return nMasternodeCollateralAmtNewEnd; }
